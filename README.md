...
## Environments
- Preview: https://main--accordion--ravise5.hlx.page/
- Live: https://main--accordion--ravise5.hlx.live/
...
1. Open the `accordion` directory in your favorite IDE and start coding :)
